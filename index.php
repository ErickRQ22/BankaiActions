...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    <header class="gradient-bg text-white py-8 px-4">
        <div class="container mx-auto text-center">
            <h1 class="text-4xl font-bold mb-2 animate-pulse">Sistema de Registro de Clientes UEES</h1>
            <p class="text-xl mb-8">ColibriHub - Soluciones Tecnológicas UEES</p>
        </div>
    </header>
    ...
    <main class="container mx-auto px-4 py-12 -mt-16">
        <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden card-hover animate-fadeIn" style="animation-delay: 0.6s;">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
                <h2 class="text-2xl font-bold">Formulario de Registro UEES ESTUDIANTE</h2>
                <p class="opacity-90">Complete la información del nuevo cliente UEES</p>
            </div>
            ...
            <div class="p-8">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    $url = 'http://179.5.156.34:8090/api/clientes';
